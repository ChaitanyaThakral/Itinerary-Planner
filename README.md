...
**X** *will be TravelItinerary which will comprise of destination, flight details, accommodation details etc.*

**Y** *will be TripOrganizer which will comprise of multiple TravelItinerary objects and manage operations on them.*
